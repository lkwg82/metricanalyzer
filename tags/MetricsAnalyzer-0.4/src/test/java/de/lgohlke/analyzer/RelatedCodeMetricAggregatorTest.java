...
public class RelatedCodeMetricAggregatorTest
{
  ...
  public void doAggregation2() throws Exception
  {
    ...
    Assert.assertEquals(2D, search.getDouble(ASTMetrics.AST_NUMBER_OF_VARIABLE_DEFINITION));
    ...
    Assert.assertEquals(31D, search.getDouble((MetricDef) Metric.LINES));
    Assert.assertEquals(25D, search.getDouble((MetricDef) Metric.LINES_OF_CODE));
    Assert.assertEquals(21D, search.getDouble((MetricDef) Metric.STATEMENTS));
    Assert.assertEquals(18D, search.getDouble(ASTMetrics.AST_NUMBER_OF_ASSERT_STATEMENTS));
