...
public class MaxAggregationRuleTest
{
  ...
  public void test()
  {
    MetricAggregationRuleAbstract rule = new MaxAggregationRule(Metric.LINES, Metric.CA);
    rule.doAggregation(accessor);

    Assert.assertEquals(3D, accessor.retrieveTestMethod().getDouble((MetricDef) Metric.LINES));
  }
}
