    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Rect) {
            final Rect copy = ((Rect) draftCopy);
            if (this.width!= null) {
                String sourceWidth;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        ...
        if (right instanceof Rect) {
            final Rect target = this;
            final Rect leftObject = ((Rect) left);
            final Rect rightObject = ((Rect) right);
            {
                String lhsWidth;
    ...
    public Rect withWidth(String value) {
        setWidth(value);
        return this;
    }

    public Rect withHeight(String value) {
        setHeight(value);
        return this;
    }

    @Override
    public Rect withX(String value) {
        setX(value);
        return this;
    }

    @Override
    public Rect withY(String value) {
        setY(value);
        return this;
    }
