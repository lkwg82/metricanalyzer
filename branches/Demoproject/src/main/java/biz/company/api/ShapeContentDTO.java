...
/**
 * <p>Java class for shapeContentDTO complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="shapeContentDTO">
 *   &lt;complexContent>
...
@XmlType(name = "shapeContentDTO", propOrder = {
    "svg"
})
public class ShapeContentDTO
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ShapeContentDTO)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ShapeContentDTO that = ((ShapeContentDTO) object);
        {
            Svg lhsSvg;
            lhsSvg = this.getSvg();
            Svg rhsSvg;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ShapeContentDTO) {
            final ShapeContentDTO copy = ((ShapeContentDTO) draftCopy);
            if (this.svg!= null) {
                Svg sourceSvg;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ShapeContentDTO) {
            final ShapeContentDTO target = this;
            final ShapeContentDTO leftObject = ((ShapeContentDTO) left);
            final ShapeContentDTO rightObject = ((ShapeContentDTO) right);
            {
                Svg lhsSvg;
    ...
    public ShapeContentDTO withSvg(Svg value) {
        setSvg(value);
        return this;
    }

    public ShapeContentDTO withUnit(Unit value) {
        setUnit(value);
        return this;
    }
