    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            double theWidth;
            theWidth = (true?this.getWidth(): 0.0D);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            double lhsWidth;
            lhsWidth = (true?this.getWidth(): 0.0D);
            double rhsWidth;
            rhsWidth = (true?that.getWidth(): 0.0D);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Dimension) {
            ...
            double sourceWidth;
            sourceWidth = (true?this.getWidth(): 0.0D);
            double copyWidth = strategy.copy(LocatorUtils.property(locator, "width", sourceWidth), sourceWidth);
            copy.setWidth(copyWidth);
            double sourceHeight;
            sourceHeight = (true?this.getHeight(): 0.0D);
            double copyHeight = strategy.copy(LocatorUtils.property(locator, "height", sourceHeight), sourceHeight);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof Dimension) {
            final Dimension target = this;
            final Dimension leftObject = ((Dimension) left);
            final Dimension rightObject = ((Dimension) right);
            {
                double lhsWidth;
                lhsWidth = (true?leftObject.getWidth(): 0.0D);
                double rhsWidth;
                rhsWidth = (true?rightObject.getWidth(): 0.0D);
                double mergedWidth = ((double) strategy.merge(LocatorUtils.property(leftLocator, "width", lhsWidth), LocatorUtils.property(rightLocator, "width", rhsWidth), lhsWidth, rhsWidth));
                target.setWidth(mergedWidth);
            }
            {
                double lhsHeight;
                lhsHeight = (true?leftObject.getHeight(): 0.0D);
                double rhsHeight;
                rhsHeight = (true?rightObject.getHeight(): 0.0D);
                double mergedHeight = ((double) strategy.merge(LocatorUtils.property(leftLocator, "height", lhsHeight), LocatorUtils.property(rightLocator, "height", rhsHeight), lhsHeight, rhsHeight));
    ...
    public Dimension withUnit(Unit value) {
        setUnit(value);
        return this;
    }
